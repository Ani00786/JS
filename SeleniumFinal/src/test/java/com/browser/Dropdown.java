...
public class Dropdown {
	...
	public static void main(String[] args) {
		...
		System.out.println("Only section links ----->");
		WebElement block = driver.findElement(By.xpath("//*[@id=\"www-wikipedia-org\"]/div[7]/div[3]"));
		List<WebElement> list11 = block.findElements(By.tagName("a"));
		System.out.println("Size of list :" + list11.size());
		
		for (WebElement a : list11) {
			System.out.println(a.getText());
			System.out.println(a.getAttribute("href"));
